	...
	public void setValueAt(Object aValue, int rowIndex, int columnIndex) {
		...
		if (cap != null) {
			...
			case 0:
				...
				break;
			case 1:
				cap.cageID = (int) aValue;
				break;
			case 2:
				cap.nFlies = (int) aValue;
				break;
			case 3:
				cap.volume = (double) aValue;
				break;
			case 4:
				cap.stimulus = aValue.toString();
				break;
			case 5:
				cap.concentration = aValue.toString();
				break;
			}
		}
	}
